  ...
  return (
    <div className='newsletter-wrapper'>
        <div className="newsletter-img">
            <motion.img initial={{height: 0}} whileInView={{height: "100%"}} transition={{delay: 0.3, duration: 1}}
            src={NewsLetterImg} alt="news-letter-img" className='img' />
        </div>
        <div className='newsletter-content'>
            <motion.h2 initial={{opacity: 0}} whileInView={{opacity:0.9}} transition={{duration: 2, delay: 0.4}}
            className='newsletter-title'>subscribe to <br /> our newsletter.</motion.h2>
            <div className="input-section">
                <motion.input initial={{width: 0}} whileInView={{width: "70%"}} transition={{duration: 2, delay: 0.6}}
                type="email" className='email-input' placeholder='Email' />
                <motion.button initial={{opacity: 0}} whileInView={{opacity: 1}} transition={{duration: 1, delay: 1.4}}

    ...
    <div className='about-container'>
        ...
        <div className='about-content-wrapper'>
            <div className='row1'>
                ...
                <div>
                <motion.div 
                initial={{opacity: 0}} whileInView={{opacity: 1}} transition={{duration:1.1, delay:0.3}}
                className='text-area text-area-1'>
                    
                    <motion.p
                    initial={{opacity: 0}} whileInView={{opacity: 1}} transition={{duration:1.1, delay:1.5}}
            ...
            <div>
                <motion.img 
                initial={{opacity:0, rotateY: "90deg"}} whileInView={{opacity: 1, rotateY: 0}} transition={{duration: 1, delay: 0.3}}

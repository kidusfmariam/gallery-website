  ...
  return (
    <div className='gallery-section-container'>
      <div className='gallery-content-wrapper'>
            <motion.img initial={{height: 0}} whileInView={{height: "100%"}} transition={{delay: 0.4, duration: 1.3}}  viewport={{once: true}}
            src={GalleryImg1} alt="gallery-img-1" className='img1' />
            <motion.img initial={{width: 0}} whileInView={{width: "120%"}} transition={{delay: 0.6, duration: 1.3}}  viewport={{once: true}}
            src={GalleryImg2} alt="gallery-img-2" className='img2' />
            <motion.img initial={{width: "0%"}} whileInView={{width: "100%"}} transition={{delay: 0.8, duration: 1.3}} viewport={{once: true}}
            src={GalleryImg3} alt="gallery-img-3" className='img3' />
            <motion.img initial={{height: 0}} whileInView={{height: "100%"}} transition={{delay: 0.9, duration: 1.3}}  viewport={{once: true}}
            src={GalleryImg4} alt="gallery-img-4" className='img4' />
            <motion.h2 initial={{opacity: 0}} whileInView={{opacity: 1}} transition={{duration: 1, delay: 1.1}} viewport={{once: true}}
            className='header'>OUR <br />ARTISTS</motion.h2>
           <Link to="/artists" style={{textDecoration: "underline", color: "#fff"}} className='cta'><motion.p  initial={{opacity: 0}} whileInView={{opacity: 1}} transition={{duration: 1, delay: 1.2}} viewport={{once: true}}
                >Explore <br/>

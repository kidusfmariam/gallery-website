  ...
  return (
    <div className='gallery-section-container'>
      <div className='gallery-content-wrapper'>
           ...
           <Link to="/artists" style={{textDecoration: "underline", color: "#fff"}} className='cta'><motion.p  initial={{opacity: 0}} whileInView={{opacity: 1}} transition={{duration: 1, delay: 1.2}}
                >Explore <br/>
